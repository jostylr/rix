...
It is an active alpha, not yet a finished general-purpose ecosystem. The parser, lowering pipeline, and broad evaluator are working and heavily tested; full equation solving and symbolic rules beyond the exact arithmetic subset remain design territory. See [implementation status](status.qmd) for the honest boundary.
