...
1. Current guides and generated reference: `index.qmd`, `getting-started.qmd`, `language-at-a-glance.qmd`, `status.qmd`, `introduction.md`, `tutorial/`, `eval/`, and `reference/`.
2. Implementation and design material: `developer-guide.qmd`, selected `parser/` pages, `design/eval/`, and `rix-rationales.md`.
