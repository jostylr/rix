...
| Mathematical systems | `{# ... }` preserves definitions, constraints, symbols, and advisory input/output roles; solving is delegated to plugins. `{$ ... }` is reserved for future async/concurrency syntax. |
