...
| Exact plugin implementations | `.fraction`, `.radix`, `.poly`, `.ratfun`, `.algebra`, `.exactAlgebras`, `.oracle`, `.ball`, `.cauchy`, `.continuedFraction`, `.algebraicReal`, `.numerics`, `.linalg`, `.optimize`, `.solve`, and the `.symbolic` meta-plugin are implemented in RiX; the linear-algebra/optimization/affine-solve stack now crosses no private JavaScript evaluator boundary |
