...
| Structured output | typed `Text`, `Paragraph`, `Heading`, `Fragment`, `Table`, `Grid`, `Graphic`, `Figure`, `Slide`, and `Slides` values, with intrinsic 2D scene primitives under `.Graphics` (`Path`, `Group`, `Transform`, `Text`, `Rectangle`, `Circle`, `Clip`) and bundled `.Draw` convenience helpers; CLI text fallback; HTML tables/grids and inline SVG graphics in the RiX notebook and web calculator; `@"..."`/`@"""..."""` templates; exact synthetic division and polynomial plotting through `.Algebra.SyntheticDivision` and `.Plot.Polynomial` |
