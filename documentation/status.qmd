...
| Structured output | typed `Text`, `Paragraph`, `Heading`, `Fragment`, `Table`, `Grid`, `Path`, `Graphic`, `Figure`, `Slide`, and `Slides` values; CLI text fallback; HTML tables/grids and inline SVG graphics in the RiX notebook and web calculator; `@"..."`/`@"""..."""` templates; exact synthetic division and polynomial plotting through `.Algebra.SyntheticDivision` and `.Plot.Polynomial` |
