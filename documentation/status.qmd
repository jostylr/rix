...
| Structured output | typed `Text`, `Paragraph`, `Heading`, `Fragment`, `Table`, `Grid`, `Graphic`, `Figure`, `Slide`, and `Slides` values, with intrinsic 2D scene primitives under `.Graphics` (`Path`, `Group`, `Transform`, `Text`, `Rectangle`, `Circle`, `Clip`); optional bundled `.draw` and `.plot` plugins load through `.Plugin.Load(...)` and produce those core scenes; CLI text fallback; HTML tables/grids and inline SVG graphics in the RiX notebook and web calculator; `@"..."`/`@"""..."""` templates; exact synthetic division through `.Algebra.SyntheticDivision` |
