...
| Structured output | typed `Text`, `Paragraph`, `Heading`, `Fragment`, `Table`, `Grid`, `Graphic`, `Figure`, `Slide`, and `Slides` values, with 2D scene primitives under `.Draw` (`Path`, `Group`, `Transform`, `Text`, `Rectangle`, `Circle`, `Clip`); CLI text fallback; HTML tables/grids and inline SVG graphics in the RiX notebook and web calculator; `@"..."`/`@"""..."""` templates; exact synthetic division and polynomial plotting through `.Algebra.SyntheticDivision` and `.Plot.Polynomial` |
