...
| 3D rendering | The renderer registry and 2D/document targets are implemented, but retained `Scene3D` values and glTF/GLB, OBJ, STL, PLY, or USD/USDZ exporters remain design work. Static camera projection belongs to `Scene3D`, not to the 2D SVG/Canvas/TikZ renderers. |
