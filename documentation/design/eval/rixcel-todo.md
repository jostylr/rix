...
- [x] Add row/column insertion with parsed reference updates.
  - [x] Add tokenizer-aware `grid`/`near` reference rewriting and dynamic-reference detection.
  - [x] Add version-3 shape-changing structural history events with cursor-safe undo/redo.
...
- [x] Add real Chromium tests for editing, insertion, fill/copy, error recovery,
  save/reopen/restart, history and bounded sparse navigation.
