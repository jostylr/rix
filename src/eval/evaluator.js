...
import { mathematicalLocalizationCapabilities } from "../runtime/math-localize.js";
...
const CORE_SYNTAX_CAPABILITIES = {
    ...
    RangePolicy: "RANGE_POLICY", RangeEvidence: "RANGE_EVIDENCE",
    RangeAdd: "RANGE_ADD", RangeSubtract: "RANGE_SUBTRACT",
    ...
    RationalBox: "RATIONAL_BOX",
    MultivariateRangeRequest: "MULTIVARIATE_RANGE_REQUEST",
    ...
    IntervalLinearSolve: "INTERVAL_LINEAR_SOLVE",
    IntervalNewtonBox: "INTERVAL_NEWTON_BOX",
...
export function createDefaultSystemContext(options = {}) {
    ...
    for (const [name, definition] of Object.entries(mathematicalLocalizationCapabilities)) ctx.register(name, definition);
