...
export const STANDARD_CAPABILITY_NAMES = Object.freeze([
    ...
    "Equal", "ERROR", "EVAL", "Exact", "ExpressionApply", "ExpressionConstant", "EXPRESSIONFROMSPEC", "ExpressionHasScopedSymbols", "ExpressionKey", "ExpressionOperation", "ExpressionVariable", "Factorial", "FIGURE", "Filter", "FIRST",
