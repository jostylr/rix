...
| `.algebra` | Implemented pure-RiX Phase 1 plus exact Phase 2 algorithms | Polynomial construction over `.poly`, verified division metadata, explicit centered/factorization presentation values with checked expansion, monic gcd/lcm, square-free and rational-factor evidence, exact resultants and sign/root-count protocols, RationalFunction integration, and synthetic-division Grids. |
