...
| `.analysis` | Implemented pure-RiX Phase 1 | Calculus-backed function sequences, native cloneable lazy term streams, versioned pointwise/uniform/almost-everywhere/in-measure/norm claims, and an exact geometric uniform-tail checker that keeps unsupported or sampled claims unknown. |
...
| Mathematical analysis expansion | `.analysis` | Scalar limits, general series, justified exchanges, and function spaces beyond the implemented Phase 1 function-sequence and geometric uniform-tail slice. |
