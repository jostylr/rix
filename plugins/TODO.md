...
| 3 | `.plot` | Linked trajectory components and Solve boxes | **Ready:** time-component, phase-portrait, and event views retain source evidence and disclose missing time coverage |
...
3. **Phase 3 — Systems, adaptation, and events**
   ...
   - [x] Add configurable-order interval Taylor/Picard stepping, highest-order
     remainder bounds, and dense certified output with retained derivative evidence.
   - [ ] Extend interval Taylor stepping to general polynomial/affine models.
   ...
   - [x] Add evidence-labeled event-time overlays and conservative whole-segment
     event phase boxes, consuming an isolation result's own solution.
   - [ ] Add linked components and Scene3D trajectory adapters.
