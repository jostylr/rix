import { pluginSources } from "./generated/rix-sources.js";
/** Register bundled opt-in plugins with a host catalog. */

const oracleSource = pluginSources['oracle/oracle.plugin.rix'];
const numericsSource = pluginSources['numerics/numerics.plugin.rix'];
const besselSource = pluginSources['bessel/bessel.plugin.rix'];
const cauchySource = pluginSources['cauchy/cauchy.plugin.rix'];
const ballSource = pluginSources['ball/ball.plugin.rix'];
const continuedFractionSource = pluginSources['continued-fraction/continued-fraction.plugin.rix'];
const algebraicRealSource = pluginSources['algebraic-real/algebraic-real.plugin.rix'];
const complexSource = pluginSources['complex/complex.plugin.rix'];
const cayleySource = pluginSources['cayley/cayley.plugin.rix'];
const quaternionSource = pluginSources['quaternion/quaternion.plugin.rix'];
const octonionSource = pluginSources['octonion/octonion.plugin.rix'];
const polySource = pluginSources['poly/poly.plugin.rix'];
const algebraSource = pluginSources['algebra/algebra.plugin.rix'];
const sternBrocotSource = pluginSources['stern-brocot/stern-brocot.plugin.rix'];
const radixSource = pluginSources['radix/radix.plugin.rix'];
const exactAlgebrasSource = pluginSources['exact-algebras/exact-algebras.plugin.rix'];
const fractionSource = pluginSources['fraction/fraction.plugin.rix'];
const ratfunSource = pluginSources['ratfun/ratfun.plugin.rix'];
const symbolicSource = pluginSources['symbolic/symbolic.plugin.rix'];
const casSource = pluginSources['cas/cas.plugin.rix'];
const logicSource = pluginSources['logic/logic.plugin.rix'];
const calculusSource = pluginSources['calculus/calculus.plugin.rix'];
const analysisSource = pluginSources['analysis/analysis.plugin.rix'];
const odeSource = pluginSources['ode/ode.plugin.rix'];
const statsSource = pluginSources['stats/stats.plugin.rix'];
const probabilitySource = pluginSources['probability/probability.plugin.rix'];
const complexVizSource = pluginSources['complex-visualization/complex-viz.plugin.rix'];
const fractalsSource = pluginSources['fractals/fractals.plugin.rix'];
const graphSource = pluginSources['graph/graph.plugin.rix'];
const combinatoricsSource = pluginSources['combinatorics/combinatorics.plugin.rix'];
const optimizeSource = pluginSources['optimize/optimize.plugin.rix'];
const linalgSource = pluginSources['linalg/linalg.plugin.rix'];
const solveSource = pluginSources['solve/solve.plugin.rix'];
const geometrySource = pluginSources['geometry/geometry.plugin.rix'];
const plotSource = pluginSources['plot/plot.plugin.rix'];
